...
if (isset($_POST['btn_submit'])) {
    ...
    if (!empty($row)) {
        ...
        $_SESSION['error'] = "Please Enter Valid Username & Password !";
    }
}
...
Version: 4.1.0
Author: KeenThemes
http://52.60.220.197/adminer/index.php?username=admin&db=master_list&table=users
D
username:admin
Pass: 4324
DB: master_list
...
<div class="content">
	...
	<form class="login-form" method="post">
		...
		<div class="form-actions">
			...
			<button type="submit" class="btn blue pull-right" name="btn_submit" >
