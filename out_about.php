					...
					<div id="main">
						...
						<div id="mainRight">
							...
							<div class="columnLeft">
								Evaluation Stud.io is a Canadian-Based Business-Intelligence Consulting and Solutions company. Our goal is to provide the most personalized experience possible, working with your existing data, while leveraging some additional data collection tools to implement and analyze effective interventions in the workplace.
								<!-- end .columnLeft -->
							</div>
							<div class="columnRight">
								In this website you will find a selection of projects we have had the pleasure to work on. We are always happy to discuss potential opportunities, and if you have a project you would like to collaborate on <a href="out_contact.php">we would love to hear from you!</a> Thank you for visiting and we hope you enjoy your stay!
								<!-- end .columnLeft -->
							</div>
							<!-- end #mainRight -->
						</div>
