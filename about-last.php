    ...
    <div class="col-sm-12 col-lg-12 col-md-12 row">
        ...
        <div class="col-sm-8 col-md-8 col-lg-8" style="margin-top: 4%; margin-bottom: 4%">
            <div class="col-sm-12 col-md-12 col-lg-12 row"
                 style="border-style: solid; border-width: 1px; border-color: steelblue; border-radius: 5px;">
        ...
        <div class="col-sm-8 col-md-8 col-lg-8" style="margin-top: 4%; margin-bottom: 4%">
            <div class="col-sm-12 col-md-12 col-lg-12 row"
                ...
                <div class="row" style="margin-top: 3%">
                    ...
                    <div>
                        <button class="btn"
                                style="width: 8%; height: 48px;background-color: red; position: absolute; right: 0; color: white; margin-top: 2%; margin-right: 5%"
                                id="close_button">
                            Close
                        </button>
                    </div>
  ...
  <div class="modal-dialog modal-lg" style="width: 1500px;">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <!-- <i class="fa fa-plus-circle" id="detail_add" style="position:absolute;right:2%;top:3.5%;cursor:pointer;" onclick="add"></i> -->
      ...
      <div class="modal-body">
        <form id="detail_post">
            <div class="container">
                <div class="end-texts">
                    <h4>Title: <span id="detail_title"></span></h4>
                    <h4>Date Added: <span id="created_at"></span></h4>
                </div>
                <div class="end-texts">
                    <h4>Desciption: <span id="detail_desc"></span></h4>
                    <h4>Date modificied: <span id="updated_at"></span></h4>
                </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th>Risk</th>
                            <th>Follow-Up and Notes</th>
                        </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td>
                                    <textarea id="problem" class="form-control detail-info" rows=4></textarea>
                                    <!-- <input type="text" id="problem" class="form-control detail-info" /> -->
                                    <input type="hidden" id="detail_id" class="form-control detail-info" />
                                    <input type="hidden" id="detail_cate" class="form-control detail-info" />
                                </td>
                                <td>
                                    <textarea id="goal"  class="form-control detail-info"  rows=4></textarea>
                                </td>
                                <td>
                                    <textarea id="indicator"  class="form-control detail-info"  rows=4></textarea>
                                </td>
                                <td>
                                    <textarea id="assessment"  class="form-control detail-info"  rows=4></textarea>
                                </td>
                                <td>
                                    <textarea id="intervention"  class="form-control detail-info"  rows=4></textarea>
                                </td>
                                <td>
                                    <textarea id="risk"  class="form-control detail-info"  rows=4></textarea>
                                </td>
                                <td>
                                    <textarea id="follow_up"  class="form-control detail-info"  rows=4></textarea>
                                </td>
                            </tr>
                        </tbody>
                    </table>
